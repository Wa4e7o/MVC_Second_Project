...
namespace MovieSystem.Data.Migrations
{
    ...
    [Migration("20220415172120_MakeIdentityRole")]
    partial class MakeIdentityRole
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieSystem.Data.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("MovieSystem.Data.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MovieSystem.Data.Models.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MovieSystem.Data.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MovieSystem.Data.Models.OrderItem", b =>
                {
                    ...
                    b.HasOne("MovieSystem.Data.Models.Order", "Order")
                        .WithMany("OrderItems")
